...
features:
  - title: 最新技术栈
    details: 使用最流行的技术SpringBoot、SpringCloud、Shiro、Thymeleaf、Vue、Element、Bootstrap。
  - title: 前后端分离
    details: 提供前后端分离的版本：使用的前端技术Vue、Element后端SpringBoot & Security完全分离的权限管理系统。
  - title: 微服务版本
    details: 提供微服务架构的版本：使用的前端技术Vue、Element、后端Spring Cloud & Alibaba微服务的权限管理系统。
  - title: 代码生成器
...
footer: MIT Licensed | Copyright © 2018-2022 ruoyi.vip All Rights Reserved 若依
---